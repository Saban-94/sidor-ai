...
export const UserApp = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#efeae2] font-sans overflow-hidden" dir="rtl">
      {/* WhatsApp Header */}
      <header className="flex items-center justify-between px-4 py-3 text-white shadow-md z-20" style={{ backgroundColor: currentProfile.color }}>
        ...
        <div className="flex items-center gap-4">
          <Camera size={20} className="opacity-80 cursor-pointer" />
          ...
          {messages.map((msg, i) => (
            ...
            >
              <div className={`max-w-[85%] p-2 rounded-xl shadow-sm relative ${
                ...
                <p className="text-sm text-gray-800 whitespace-pre-wrap leading-relaxed pb-3" dangerouslySetInnerHTML={{ __html: msg.text }} />
      ...
      <footer className="p-2 bg-[#f0f2f5] flex items-center gap-2 z-20">
        <div className="flex-1 bg-white rounded-full px-4 py-2 flex items-center gap-2 shadow-sm">
          ...
          />
          <label className="cursor-pointer text-gray-500 hover:text-sky-600">
